...
PACKAGE ?= helm-crossplane
XRD_DIR := apis/crossplanes
COMPOSITION := $(XRD_DIR)/composition.yaml
DEFINITION := $(XRD_DIR)/definition.yaml
EXAMPLE_DEFAULT := examples/crossplanes/standard.yaml
...
EXAMPLES := \
    examples/crossplanes/minimal.yaml:: \
    examples/crossplanes/standard.yaml::
...
render\:%:
	@example="examples/crossplanes/$*.yaml"; \
	up composition render --xrd=$(DEFINITION) $(COMPOSITION) $$example
